...
For a demo page showing examples for all past RCV contests in the elections
from 2019 to 2022, go here:
...
(The HTML format is an improved version of the English-only HTML format
that Dominion's voting system used to generate before 2019 but doesn't
any longer. See
...
The project can also output RCV results in a short summary format
for inclusion in a results summary web page of several contests.
For example, below is another screenshot from the demo of the summary
generated by this project for the above contest.
