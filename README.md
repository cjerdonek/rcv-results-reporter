...
This project contains a small collection of Python scripts to generate HTML
...
Democracy Suite voting system. The project is open source.

The project supports parsing both the XML and Excel (`.xlsx`) RCV reports
